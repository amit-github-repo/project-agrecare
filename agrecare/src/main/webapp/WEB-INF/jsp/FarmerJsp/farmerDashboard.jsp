...
<body>
	...
	<div id="mySidenav" class="sidenav">
	  ...
	  <a href="#">View all Seller and Doctor</a>
	  <a href="/equipmentRequest">Request Seller for eqpt.</a>
	  <a href="/Crop-Details">Crop details</a>
	  <a href="/Request-for-advice">Request for plant problem</a>
	...
	<h2>WellCome Farmer to AgreCare</h2>
